...
##Definition
An SIF appears when an account is created with a mix of hybrid information, real and fake information from a person taking the SSN from deceased persons or minor children. This person grows and enhances their image with the financial companies and requests more credit, and at their max peak of credit, they will request the credit in full and will not pay again. 
...
-	
o	Bust-out-signals (investigate immediately):
